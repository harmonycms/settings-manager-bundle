            ...
            ->children()
                ...
                ->arrayNode('settings_classes')
                    ...
                    ->children()
                        ...
                        ->end()
                        ->scalarNode('setting_document')
                            ->info('Setting document class (FQDN)')
                            ->defaultValue('App\Document\Setting')
                        ->end()
                        ->scalarNode('setting_tag_document')
                            ->info('SettingTag document class (FQDN)')
                            ->defaultValue('App\Document\SettingTag')
                        ->end()
                    ->end()
                ->end()
